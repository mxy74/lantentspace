...
python ace_run.py --num_parallel_workers 0 --target_class car --source_dir SOURCE_DIR --working_dir SAVE_DIR --model_to_run ResNet20 --model_path ./ResNet20.pt --labels_path ./cifar10_labels.txt --bottlenecks avgpool --num_random_exp 2 --max_imgs 5000 --min_imgs 1000
```

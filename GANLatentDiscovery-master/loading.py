...
from models.gan_load import make_big_gan_cifar10, make_big_gan, make_proggan, make_sngan
device_id = 0
...
def load_generator(args, G_weights):
    ...
    elif 'BigGAN_CIFAR10' in gan_type:
        G = make_big_gan_cifar10(G_weights, args['target_class'])
    else:
